        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <br/>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">Chọn thumbnail</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <c:if test="${not empty model.thumbnail}">
                                <img src="<c:url value='/repository/${model.thumbnail}'/>" id="viewImage" width="150px" height="150px">
                            </c:if>
                            <c:if test="${empty model.thumbnail}">
                                <img src="<c:url value='/template/image/default.png'/>" id="viewImage" width="150px" height="150px">
                            </c:if>
                        </div>
                    </div>
