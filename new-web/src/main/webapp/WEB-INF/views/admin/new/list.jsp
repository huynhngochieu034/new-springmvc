...
<c:url var="deleteNewAPI" value="/api/admin/new"/>
                                ...
                                <div class="table-responsive">
                                    <display:table name="model.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                        ...
                                        <display:column title="<fieldset class='form-group'>
                                            ...
                                            <fieldset>
                                                <input type="checkbox" class="check-box-element" id="checkbox_${tableList.id}" value="${tableList.id}"/>
                                            </fieldset>
                                        </display:column>
                                        <display:column headerClass="text-left" property="title" title="Tên bài viết"/>
                                        <display:column headerClass="text-left" property="shortDescription" title="Mô tả ngắn"/>
                                        <display:column headerClass="col-actions" title="Thao tác">
                                            <c:url var="editNew" value="/admin/new/edit">
                                                <c:param name="id" value="${tableList.id}"/>
                                            </c:url>
                                            <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                               title="Cập nhật bài viết" href='${editNew}'>
